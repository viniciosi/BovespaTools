...
dfCodigosNegociacao = pd.read_csv("errosPegarPreco.csv", sep = ";")

# pegar preços
for indice, codigoNeg in dfCodigosNegociacao.iloc[1000:2000].iterrows():
    if str(codigoNeg['codigo']) != "":
        log = open("log" + "Preco2", 'a', encoding = 'utf-8')
...
dfCodigosNegociacao.to_csv("consCod2.csv", sep = ";", encoding = 'utf-8-sig')
