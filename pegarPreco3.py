...
# pegar preços
for indice, codigoNeg in dfCodigosNegociacao.iloc[2000:3000].iterrows():
    log = open("log" + "Preco3", 'a', encoding = 'utf-8')
    ...
    log.close()
dfCodigosNegociacao.to_csv("consCod3.csv", sep = ";", encoding = 'utf-8-sig')